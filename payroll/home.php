...
<!-- !PAGE CONTENT! -->
  ...
  <img src="images/homepic1.jpeg" alt="Lights" style="width:120%;height:0%">
  ...
  <div class="w3-display-topmiddle" style="font-size: 35px"><p>   WELCOME TO PAYROLL MANAGEMENT </p></div>
  <div class="w3-display-left w3-container"> <ul class="w3-ul">
  ...
  <div class="w3-display-middle w3-large w3-text-white">  </div>
