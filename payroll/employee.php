...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
     ...
     <div class="w3-display-container w3-text-white" style="font-size: 100px">
          ...
          <div class="w3-display-middle w3-large" > <h1 >EMPLOYEE</h1></div>
      </div>
   <div class="w3-container">
      <h3>Employee Data</h3>
       
       <a href="employee-add.php" class="w3-button w3-black w3-right">Add employee <span class="w3-text-red">+</span></a>
       <br><br>
       <table>
